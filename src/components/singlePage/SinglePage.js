...
const SinglePage = () => {
    let img = 'https://d19h8kn98xvxar.cloudfront.net/images/_hero/connectwithnature.jpg'
    // style={{background: `url(${img})`, backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "contain"}}
  return (
    <div className='single_pages container'>
        ...
        <div className="single_container">
            <div className="single_left_img">
                <div className="single_all_img_container ">
                    <div className="img_scroll_bar">
                        <div className="single_all_img"><img src="https://d19h8kn98xvxar.cloudfront.net/images/_hero/connectwithnature.jpg" alt="" /></div>
                    </div>
                </div>
                <div className="single_center_img_container">
                    ...
                    <div className="single_center_img_icon_container">
                        ...
                        <button><LiaSearchPlusSolid/></button>
                    </div>
                </div>
            </div>
            <div className="single_right_all_title">
                ...
                <h2>PAW Patrol: The Mighty Movie, Skye 12-inch Tall Premium Plush Toy for Kids 3+</h2>
                <b>$14.97</b>
